...
const defaultProjects: Project[] = [
    ...
    { id: 11, title: 'Kidz Knowledge', description: 'An engaging and educational platform for kids, designed to make learning fun and interactive.', imgSrc: 'https://placehold.co/600x400.png', tags: ["Kids", "Education", "Next.js"], liveUrl: "https://kidz-knowledge.vercel.app/", githubUrl: "https://github.com/hassanzubair99/kid-knowledge", imgHint: "kids learning" },
];
